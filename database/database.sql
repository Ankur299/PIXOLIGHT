...
create table pico.users(id int(10) not null auto_increment, name varchar(100), phone bigint(12), email varchar(100), password varchar(100), profile varchar(100), verified varchar(10),upi varchar(100), primary key (id));
create table pico.posts(id int(10) not null auto_increment, user_id int(10), image_dir varchar(120), price int(10), caption varchar(200), camera varchar(50), lens varchar(20), focal varchar(20), shutter varchar(20), iso varchar(20),primary key (id));
